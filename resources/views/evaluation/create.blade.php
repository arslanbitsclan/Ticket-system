@extends('layouts.app')
@section('title', 'Create a new evaluation')
@section('content')
...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
	...
	<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
		...
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			<!--begin::Title-->
			<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Create a new evaluation</h1>
			<!--end::Title-->
			<!--begin::Breadcrumb-->
		...
		<div class="card mb-5 mb-xl-10">
            <div class="card-header border-0">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Create a new evaluation</h3>
                </div>
            </div>
            <form class="form" action="{{ route('evaluation.store') }}" method="POST" id="kt_modal_add_evaluation_form">
                @csrf
                <div class="card-body border-top p-9">
                    <div class="row g-9 mb-7">
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2" for="type">Type</label>
                            <input class="form-control form-control-solid" type="text" placeholder="Please enter evaluation type" name="type" id="type" value="{{ old('type')}}"/>
                        </div>
                    </div>
                    ...
                    <div class="row g-9 mb-7">
                        <div class="col-md-6 fv-row">
                            ...
                            <input class="form-control form-control-solid" type="text" placeholder="Please enter question" required name="question[]" id="question"/>
                        </div>
...
var KTModalRoleAdd = function () {
    ...
    return {
        ...
        init: function () {
            // Elements
            form = document.querySelector('#kt_modal_add_evaluation_form');
