            ...
            <div class="content">
                ...
                <table role="presentation" class="main">
                    ...
                    <tr>
                        <td class="header">
                            <a href="#">
                                <img style="height: 100px; width: auto; margin: 15px auto;display: block" src="https://planzcreatives.com/wp-content/uploads/2022/03/admin-ajax-3.png" alt="help desk" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td class="wrapper">
                            ...
                            <table role="presentation" class="main-table" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Hi {{ $customer }},</p>
                                        <p>{{ $update_msg }} The following is the ticket info, you would be able to see in details with visiting the ticket link.</p>
                                        ...
                                        <p>Thank you!</p>
                                        <p>Best regards, <br/>MCB ARIF HABIB</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="content-block powered-by">
                                 © {{ date("Y") }} <a href="https://aaqoo.com">Aaqoo</a> - All rights reserved.
                            </td>
                        </tr>
                    </table>
                </div>
