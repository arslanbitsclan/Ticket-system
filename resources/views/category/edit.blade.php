...
<div id="kt_app_content" class="app-content flex-column-fluid">
	...
	<div id="kt_app_content_container" class="app-container container-fluid">
		<div class="card mb-5 mb-xl-10">
            ...
            <form class="form" action="{{ route('category.update',$category->id) }}" method="POST" id="kt_modal_add_category_form">
                @csrf
                @method('PATCH')
                <div class="card-body border-top p-9">
                    <div class="row g-9 mb-7">
                        <div class="col-md-6 fv-row">
                            ...
                            <input class="form-control form-control-solid" type="text" placeholder="Please enter category name" name="name" id="name" value="{{ old('name') ?? $category->name }}"/>
                        </div>
