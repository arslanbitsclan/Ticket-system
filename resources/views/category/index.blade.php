...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
	...
	<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
		...
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			<!--begin::Title-->
			<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Catgeory</h1>
			<!--end::Title-->
			<!--begin::Breadcrumb-->
			...
			<div class="card-header border-0 pt-6">
				...
				<div class="card-toolbar">
					...
					<div class="d-flex justify-content-end" data-kt-category-table-toolbar="base">
						@can('add-category')
						<!--begin::Add category-->
						<a href="{{ route('category.create') }}" class="btn btn-primary">Add Catgeory</a>
						<!--end::Add category-->
						@endcan
					</div>
					<!--end::Toolbar-->
...
<script>
      $(document).ready(function () {
		...
		try {
			...
			let data_table = $('#category_table').DataTable({
				serverSide: true,
				stateSave: false,
				ajax: {
		...
		$(document).on("click", ".delete", function(){
			...
			Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
						url: "{{ route('category.delete-ajax')}}",
						type: "POST",
						data:  {id: id},
