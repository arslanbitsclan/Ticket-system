...
@elseif( $col == 'actions' )
    ...
    <div class="text-end">
        ...
        @can('delete-category')
        <button type="button" class="btn btn-sm btn-icon btn-danger delete" data-delete-id = {{ $category->id}} data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title="Delete Role"><i class="fa-sharp fa-solid fa-trash"></i></button>
        @endcan
    </div>
    @endcanany
@endif
