...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
	...
	<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
		...
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			<!--begin::Title-->
			<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Create a new survey</h1>
			<!--end::Title-->
			<!--begin::Breadcrumb-->
		...
		<div class="card mb-5 mb-xl-10">
            <div class="card-header border-0">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Create a new survey</h3>
                </div>
            </div>
            <form class="form" action="{{ route('survey.store') }}" method="POST" id="kt_modal_add_ticket_form" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row g-9 mb-7">
                            ...
                            @foreach ($evaluation->questions as $question)
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input class="form-control form-control-solid" type="text" placeholder="Please enter answer" name="answer[{{  $evaluation->id }}][{{ $question->id }}]" id="answer[{{  $evaluation->id }}][{{ $question->id }}]" data-fv-not-empty="true" data-fv-not-empty___message="The answer is required"/>
                                </div>
